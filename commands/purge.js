...
module.exports = {
    ...
    async execute(interaction) {
        ...
        // Check if the user has the required permissions
        if (client.permissions.has(PermissionsBitField.Flags.ManageMessages)) {
            await interaction.reply({ content: 'The bot is missing the required permissions.', ephemeral: true });
            return;
        }
